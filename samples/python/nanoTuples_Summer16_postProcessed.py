...
#dirs['TTX']              = dirs['TTG'] + dirs['TTW'] + dirs['TTZ']
...
TTLep_pow_16            = Sample.fromDirectory(name="TTLep_pow",            treeName="Events", isData=False, color=color.TTJets,          texName="t#bar{t}/single-t",              directory=directories['TTLep_pow'])
...
#TTX_16            = Sample.fromDirectory(name="TTX",              treeName="Events", isData=False, color=color.TTW,             texName="t#bar{t}X",                         directory=directories['TTX'])
