...
dirs['QCD_Mu'] 		= ["QCD_Mu_pt20to30", "QCD_Mu_pt30to50", "QCD_Mu_pt50to80", "QCD_Mu_pt80to120", "QCD_Mu_pt120to170", "QCD_Mu_pt170to300", "QCD_Mu_pt300to470", "QCD_Mu_pt470to600","QCD_Mu_pt600to800","QCD_Mu_pt800to1000","QCD_Mu_pt1000toInf" ]
...
Top_pow_17              = Sample.fromDirectory(name="Top_pow",              treeName="Events", isData=False, color=color.Top_pow,         texName="t#bar{t}/t",                     directory=directories['Top_pow'])
...
TTSingleLep_pow_17      = Sample.fromDirectory(name="TTSingleLep_pow",      treeName="Events", isData=False, color=color.TTJets_1l,       texName="t#bar{t} (1l)",                  directory=directories['TTSingleLep_pow'])
...
QCD_Ele_17  		= Sample.fromDirectory(name="QCD_Ele",    	    treeName="Events", isData=False, color=color.QCD_Ele,          texName="QCD (Ele)",                 directory=directories['QCD_Ele'])
QCD_Mu_17  		= Sample.fromDirectory(name="QCD_Mu",    	    treeName="Events", isData=False, color=color.QCD_Mu,          texName="QCD (Mu)",                 directory=directories['QCD_Mu'])
