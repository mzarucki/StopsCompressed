...
#argParser.add_argument('--selection',          		action='store',      default='nISRJets1p-njet2-ntau0-lepSel-deltaPhiJets-jet3Veto-met200-ht300')
...
read_variables = [
            "weight/F", "l1_pt/F", "l1_eta/F" , "l1_phi/F", "l1_pdgId/I", "l1_muIndex/I", "reweightHEM/F","l1_miniRelIso/F", "l1_relIso03/F", 
...
#        event.l1_phi = float('nan')  
#        event.l1_eta = float('nan') 
