...
def combineSFs(baseHistName, updateHistName, updatePtRange, file_dir = './', savedir = './', drawOriginalSFs = False, verbose = False):
    ...
    leptonSFsDict = {
        # muons
        #"mu_LooseWP_2D_cent":{"tag":'LooseWP_cent', "hist_name":'NUM_LooseID_DEN_genTracks_pt_abseta',                             "file_name":'RunBCDEF_SF_ID.root', "lep":'mu', 'dim':'2D'},
        ...
        "mu_LooseWP_1D_priv":{"tag":'LooseWP_priv', "hist_name":'muon_SF_Id_2D',                  "file_name":'hephy_scale_factors.root',                                "lep":'mu', 'dim':'2D'},
        #"mu_IpIso_1D_priv":  {"tag":'IpIso_priv',   "hist_name":'muon_SF_IpIsoSpec_all',          "file_name":'hephy_scale_factors.root',                                "lep":'mu', 'dim':'1D'},
        "mu_IpIso_1D_priv":  {"tag":'IpIso_priv',   "hist_name":'muon_SF_IpIsoSpec_2D',           "file_name":'hephy_scale_factors.root',                                "lep":'mu', 'dim':'2D'},
        
        # electrons
        #"el_VetoWP_2D_cent": {"tag":'VetoWP_cent',  "hist_name":'Run2016_CutBasedVetoNoIso94XV2', "file_name":'ElectronScaleFactors_Run2016',                            "lep":'el', 'dim':'2D'},
    ...
    combinedHistName = "%s_SF_%s_%s_2016"%(selectedHistDict[baseHistName]['lep'], selectedHistDict[baseHistName]['dim'], combinedHistDict['tag'])
	...
	print "etadelta: ", positiveEtaBinsDelta
            ...
            for ybin in range(1, ny+1):
                ...
                # updated values
                    ...
                    if selectedHistDict[updateHistName]['dim'] == "2D":
                        ...
                        binContent = selectedHistDict[updateHistName]['hist'].GetBinContent(xbin-basePtBinsLowerDelta, ybin+positiveEtaBinsDelta)
                        binError   = selectedHistDict[updateHistName]['hist'].GetBinError(xbin-basePtBinsLowerDelta, ybin+positiveEtaBinsDelta)
...
if __name__ == '__main__':
    #savedir = "/mnt/hephy/cms/priya.hussain/www/StopsCompressed/leptonSFs/2018/combinedSFs"
    savedir = "/mnt/hephy/cms/priya.hussain/www/StopsCompressed/leptonSFs/2016/noIso_final/combinedSFs"
    #combineSFs(baseHistName = 'mu_LooseWP_2D_cent', updateHistName = 'mu_LooseWP_1D_priv', updatePtRange = [3.5, 20], file_dir = '/scratch/priya.hussain/StopsCompressed/results/2017_94X/finalplots/', savedir = savedir, drawOriginalSFs = True, verbose = True)
    #combineSFs(baseHistName = 'mu_LooseWP_2D_cent', updateHistName = 'mu_LooseWP_1D_priv', updatePtRange = [3.5, 20], file_dir = '/scratch/priya.hussain/StopsCompressed/results/2018_94_pre3/finalplots/', savedir = savedir, drawOriginalSFs = True, verbose = True)
    combineSFs(baseHistName = 'mu_LooseWP_2D_cent', updateHistName = 'mu_LooseWP_1D_priv', updatePtRange = [3.5, 10], file_dir = '/mnt/hephy/cms/priya.hussain/StopsCompressed/results/2016_80X_v5/finalplots/cent/', savedir = savedir, drawOriginalSFs = True, verbose = True)
