...
argParser.add_argument('--targetDir',          		action='store',      default='v6test3')
#argParser.add_argument('--selection',          	action='store',      default='nISRJets1p-ntau0-lepSel-deltaPhiJets-jet3Veto-met200-ht300-mt170')
argParser.add_argument('--selection',          		action='store',      default='nISRJets1p-ntau0-lepSel-deltaPhiJets-jet3Veto-met200-ht300-HEMJetVetoWide')
...
#	print event.weight, event.reweightL1Prefire
...
def lepton_flavour (event, sample):
	...
	if abs(event.l1_pdgId) == 13:
		...
		event.mu_phi = event.l1_phi
		event.mu_eta = event.l1_eta
		event.mu_dxy = event.l1_dxy
		event.mu_dz  = event.l1_dz

	elif abs(event.l1_pdgId) == 11:
		event.el_pt = event.l1_pt
		event.el_phi = event.l1_phi
		event.el_eta = event.l1_eta
		event.el_dxy = event.l1_dxy
		event.el_dz  = event.l1_dz
...
for sample in samples:
	read_variables += [ "reweightL1Prefire/F"]
	sample.weight = lambda event, sample: event.reweightL1Prefire
...
#for sample in samples: print sample.scale, sample.name 
...
plots.append(Plot(name = "muon_eta_distribution",
    texX = '#eta(mu) (GeV)', texY = 'Number of Events ',
    attribute = lambda event, sample: event.mu_eta,
    binning=[15,-3,3],
  ))
plots.append(Plot(name = "muon_phi_distribution",
    texX = '#phi(mu) (GeV)', texY = 'Number of Events ',
    attribute = lambda event, sample: event.mu_phi,
    binning=[20,-pi,pi],
  ))
plots.append(Plot(name = "muon_dxy_distribution",
    texX = 'dxy(mu) (GeV)', texY = 'Number of Events ',
    attribute = lambda event, sample: event.mu_dxy,
    binning=[20,-.02,.02],
  ))
plots.append(Plot(name = "muon_dz_distribution",
    texX = 'dz(mu) (GeV)', texY = 'Number of Events ',
    attribute = lambda event, sample: event.mu_dz,
    binning=[20,-.1,.1],
  ))
...
plots.append(Plot(name = "electron_eta_distribution",
    texX = '#eta(el) (GeV)', texY = 'Number of Events ',
    attribute = lambda event, sample: event.el_eta,
    binning=[15,-3,3],
  ))
plots.append(Plot(name = "electron_phi_distribution",
    texX = '#phi(el) (GeV)', texY = 'Number of Events ',
    attribute = lambda event, sample: event.el_phi,
    binning=[20,-pi,pi],
  ))
plots.append(Plot(name = "electron_dxy_distribution",
    texX = 'dxy(el) (GeV)', texY = 'Number of Events ',
    attribute = lambda event, sample: event.el_dxy,
    binning=[20,-.02,.02],
  ))
plots.append(Plot(name = "electron_dz_distribution",
    texX = 'dz(el) (GeV)', texY = 'Number of Events ',
    attribute = lambda event, sample: event.el_dz,
    binning=[20,-.1,.1],
  ))
