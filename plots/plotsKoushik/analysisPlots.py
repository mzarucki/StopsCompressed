...
argParser.add_argument('--selection',          action='store',      default='nisrjet1-dphij0j10To2.5-met200-ht200')
#argParser.add_argument('--selection',          action='store',      default='nisrjet1-nbtag0-lepSel-dphij0j10To2.5-met200-ht200')
#argParser.add_argument('--selection',          action='store',      default='nisrjet1-nbtag0-lepSel-met200-ht200')
...
def drawPlots(plots):
  for log in [False, True]:
    plot_directory_ = os.path.join(plot_directory, 'analysisPlots', args.targetDir, args.selection, ("log" if log else ""))
    for plot in plots:
...
read_variables = [
            ...
            "met_pt/F", "met_phi/F", "ht/F","mt/F", "genWeight/F",'l1_dxy/F', 'l1_dz/F', 'dphij0j1/F', 'nISRJets/I','nSoftBJets/I','nHardBJets/I', "nBTag/I", "nJetGood/I", "PV_npvsGood/I"]
read_variables += [
            "nMuon/I",
...
stack = Stack( WJets_18,Top_pow_18, Top_pow_1l_18)
# Use some defaults
