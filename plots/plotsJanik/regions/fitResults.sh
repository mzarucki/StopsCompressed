...
python fitResults.py --plotRegionPlot --cardfile T2tt_500_420 --year '2017' --l1pT_CR_split --mT_cut_value 95 --CT_cut_value 400 --extra_mT_cut --carddir /scratch-cbe/users/priya.hussain/StopsCompressed/results/2017/fitAllregion_dphiJets_nbins88_mt95_extramTTrue_CT400_isPromptFalse/cardFiles/T2tt/expected/ 

python fitResults.py --plotRegionPlot --cardfile T2tt_500_420 --year '2018' --l1pT_CR_split --mT_cut_value 95 --CT_cut_value 400 --extra_mT_cut --carddir /scratch-cbe/users/priya.hussain/StopsCompressed/results/2018/fitAllregion_dphiJets_nbins88_mt95_extramTTrue_CT400_isPromptFalse/cardFiles/T2tt/expected/ 
