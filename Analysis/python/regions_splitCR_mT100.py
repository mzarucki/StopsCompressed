...
SR1vlbX = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (3.5,5)) + Region ("CT1", (300,400))   
SR1lbX  = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (5,12))  + Region ("CT1", (300,400)) 
SR1mbX  = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (12,20)) + Region ("CT1", (300,400)) 
SR1hbX  = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (20,30)) + Region ("CT1", (300,400)) 

SR1vlbY = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (3.5,5)) + Region ("CT1", (400,-999)) 
SR1lbY  = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (5,12))  + Region ("CT1", (400,-999)) 
SR1mbY  = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (12,20)) + Region ("CT1", (400,-999)) 
SR1hbY  = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (20,30)) + Region ("CT1", (400,-999)) 

CR1mbX   = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (30,50)) + Region ("CT1", (300,400))   
CR1mbY   = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (30,50)) + Region ("CT1", (400, -999)) 

CR1hbX   = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (50,-999)) + Region ("CT1", (300,400))   
CR1hbY   = SR1 + Region("mt", (60,100)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (50,-999)) + Region ("CT1", (400, -999)) 

SR1lcX  = SR1 + Region("mt", (100,-999)) + Region("l1_pt", (5,12))  + Region ("CT1", (300,400))   
SR1mcX  = SR1 + Region("mt", (100,-999)) + Region("l1_pt", (12,20)) + Region ("CT1", (300,400)) 
SR1hcX  = SR1 + Region("mt", (100,-999)) + Region("l1_pt", (20,30)) + Region ("CT1", (300,400)) 

SR1lcY  = SR1 + Region("mt", (100,-999)) + Region("l1_pt", (5,12))  + Region ("CT1", (400,-999)) 
SR1mcY  = SR1 + Region("mt", (100,-999)) + Region("l1_pt", (12,20)) + Region ("CT1", (400,-999)) 
SR1hcY  = SR1 + Region("mt", (100,-999)) + Region("l1_pt", (20,30)) + Region ("CT1", (400,-999)) 


CR1mcX   = SR1 + Region("mt", (100,-999)) + Region("l1_pt", (30,50)) + Region ("CT1", (300,400))   
CR1mcY   = SR1 + Region("mt", (100,-999)) + Region("l1_pt", (30,50)) + Region ("CT1", (400, -999)) 

CR1hcX   = SR1 + Region("mt", (100,-999)) + Region("l1_pt", (50,-999)) + Region ("CT1", (300,400))   
CR1hcY   = SR1 + Region("mt", (100,-999)) + Region("l1_pt", (50,-999)) + Region ("CT1", (400, -999)) 
...
SR2vlbX = SR2 + Region("mt", (60,100))  + Region("l1_pt", (3.5,5)) + Region ("CT2", (300,400))   
SR2lbX  = SR2 + Region("mt", (60,100))  + Region("l1_pt", (5,12))  + Region ("CT2", (300,400)) 
SR2mbX  = SR2 + Region("mt", (60,100))  + Region("l1_pt", (12,20)) + Region ("CT2", (300,400)) 
SR2hbX  = SR2 + Region("mt", (60,100))  + Region("l1_pt", (20,30)) + Region ("CT2", (300,400)) 

SR2vlbY = SR2 + Region("mt", (60,100))  + Region("l1_pt", (3.5,5)) + Region ("CT2", (400,-999))  
SR2lbY  = SR2 + Region("mt", (60,100))  + Region("l1_pt", (5,12))  + Region ("CT2", (400,-999)) 
SR2mbY  = SR2 + Region("mt", (60,100))  + Region("l1_pt", (12,20)) + Region ("CT2", (400,-999)) 
SR2hbY  = SR2 + Region("mt", (60,100))  + Region("l1_pt", (20,30)) + Region ("CT2", (400,-999)) 

CR2mbX    = SR2 + Region("mt", (60,100))   + Region("l1_pt", (30,50)) + Region ("CT2", (300,400)) 
CR2mbY    = SR2 + Region("mt", (60,100))   + Region("l1_pt", (30,50)) + Region ("CT2", (400, -999)) 

CR2hbX    = SR2 + Region("mt", (60,100))   + Region("l1_pt", (50,-999)) + Region ("CT2", (300,400)) 
CR2hbY    = SR2 + Region("mt", (60,100))   + Region("l1_pt", (50,-999)) + Region ("CT2", (400, -999)) 


SR2lcX  = SR2 + Region("mt", (100,-999))  + Region("l1_pt", (5,12))  + Region ("CT2", (300,400)) 
SR2mcX  = SR2 + Region("mt", (100,-999))  + Region("l1_pt", (12,20)) + Region ("CT2", (300,400)) 
SR2hcX  = SR2 + Region("mt", (100,-999))  + Region("l1_pt", (20,30)) + Region ("CT2", (300,400)) 

SR2lcY  = SR2 + Region("mt", (100,-999))  + Region("l1_pt", (5,12))  + Region ("CT2", (400,-999)) 
SR2mcY  = SR2 + Region("mt", (100,-999))  + Region("l1_pt", (12,20)) + Region ("CT2", (400,-999)) 
SR2hcY  = SR2 + Region("mt", (100,-999))  + Region("l1_pt", (20,30)) + Region ("CT2", (400,-999)) 

CR2mcX    = SR2 + Region("mt", (100,-999))   + Region("l1_pt", (30,50)) + Region ("CT2", (300,400)) 
CR2mcY    = SR2 + Region("mt", (100,-999))   + Region("l1_pt", (30,50)) + Region ("CT2", (400, -999)) 

CR2hcX    = SR2 + Region("mt", (100,-999))   + Region("l1_pt", (50,-999)) + Region ("CT2", (300,400)) 
CR2hcY    = SR2 + Region("mt", (100,-999))   + Region("l1_pt", (50,-999)) + Region ("CT2", (400, -999)) 
