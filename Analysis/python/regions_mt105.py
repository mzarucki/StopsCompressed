...
CR1bX   = SR1 + Region("mt", (60,105)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (30,-999)) + Region ("CT1", (300,400))   
CR1bY   = SR1 + Region("mt", (60,105)) + Region("l1_charge", (-1,-1))  + Region("l1_pt", (30,-999)) + Region ("CT1", (400, -999)) 
...
CR1cX   = SR1 + Region("mt", (105,-999)) + Region("l1_pt", (30,-999)) + Region ("CT1", (300,400))   
CR1cY   = SR1 + Region("mt", (105,-999)) + Region("l1_pt", (30,-999)) + Region ("CT1", (400, -999)) 
...
CR2bX    = SR2 + Region("mt", (60,105))   + Region("l1_pt", (30,-999)) + Region ("CT2", (300,400)) 
CR2bY    = SR2 + Region("mt", (60,105))   + Region("l1_pt", (30,-999)) + Region ("CT2", (400, -999)) 
...
CR2cX    = SR2 + Region("mt", (105,-999))   + Region("l1_pt", (30,-999)) + Region ("CT2", (300,400)) 
CR2cY    = SR2 + Region("mt", (105,-999))   + Region("l1_pt", (30,-999)) + Region ("CT2", (400, -999)) 
