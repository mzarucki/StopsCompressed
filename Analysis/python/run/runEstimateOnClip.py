...
cmd = "submit --title='est16' --walltime 07:00:00 "
# cmd = "echo"
...
for i in range(88): #needed for split l1_pt region and split in further mT region 
	...
	os.system(cmd+" 'python run_estimate.py --selectEstimator DY        --year 2016 --all --l1pT_CR_split --extra_mT_cut --CT_cut_value 400 --selectRegion %s'"%str(i))
