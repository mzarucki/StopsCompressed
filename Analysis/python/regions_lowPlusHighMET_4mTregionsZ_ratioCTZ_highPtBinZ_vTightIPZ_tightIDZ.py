...
SRZ = Region("MET_pt", (200,-999)) + Region("CT1", (0,300)) + Region("ISRJets_pt", (130,-999)) + Region("abs(l1_pdgId)", (13,13)) + Region("l1_eta", (-1.5, 1.5)) # NOTE: opening up Z to higher MET at lower HT
...
SR1laZ0p7  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.6,0.7))  
SR1maZ0p7  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.6,0.7))  
SR1haZ0p7  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.6,0.7))  
SR1vhaZ0p7 = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.6,0.7))  
                                  
SR1laZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.7,0.8))  
SR1maZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.7,0.8))  
SR1haZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.7,0.8))  
SR1vhaZ0p8 = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.7,0.8))  
                                  
SR1laZ0p9  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.8,0.9))  
SR1maZ0p9  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.8,0.9))  
SR1haZ0p9  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.8,0.9))  
SR1vhaZ0p9 = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.8,0.9))  
                                  
SR1laZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.9,1))    
SR1maZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.9,1))    
SR1haZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.9,1))    
SR1vhaZ1p0 = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.9,1))    
                                  
SR1laZ1p1  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (1,1.1))    
SR1maZ1p1  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (1,1.1))    
SR1haZ1p1  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (1,1.1))    
SR1vhaZ1p1 = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (1,1.1))    
                                  
SR1laZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (1.1,1.2))  
SR1maZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (1.1,1.2))  
SR1haZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (1.1,1.2))  
SR1vhaZ1p2 = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (1.1,1.2))  
...
CR1aZ0p7  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.6,0.7))  
CR1aZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.7,0.8))  
CR1aZ0p9  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.8,0.9))  
CR1aZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.9,1))    
CR1aZ1p1  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (1,1.1))    
CR1aZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (1.1,1.2))  
...
SR1lbZ0p7  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.6,0.7))  
SR1mbZ0p7  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.6,0.7))  
SR1hbZ0p7  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.6,0.7))  
SR1vhbZ0p7 = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.6,0.7))  

SR1lbZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.7,0.8))  
SR1mbZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.7,0.8))  
SR1hbZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.7,0.8))  
SR1vhbZ0p8 = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.7,0.8))  

SR1lbZ0p9  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.8,0.9))  
SR1mbZ0p9  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.8,0.9))  
SR1hbZ0p9  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.8,0.9))  
SR1vhbZ0p9 = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.8,0.9))  

SR1lbZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.9,1))    
SR1mbZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.9,1))    
SR1hbZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.9,1))    
SR1vhbZ1p0 = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.9,1))    

SR1lbZ1p1  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (1,1.1))    
SR1mbZ1p1  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (1,1.1))    
SR1hbZ1p1  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (1,1.1))    
SR1vhbZ1p1 = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (1,1.1))    

SR1lbZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (1.1,1.2))  
SR1mbZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (1.1,1.2))  
SR1hbZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (1.1,1.2))  
SR1vhbZ1p2 = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (1.1,1.2))  
...
CR1bZ0p7  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.6,0.7))  
CR1bZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.7,0.8))  
CR1bZ0p9  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.8,0.9))  
CR1bZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.9,1))    
CR1bZ1p1  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (1,1.1))    
CR1bZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_charge", (-1,-1)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (1.1,1.2))  
