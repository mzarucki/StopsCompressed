...
SR1laZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.6,0.8))  
SR1maZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.6,0.8))  
SR1haZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.6,0.8))  
SR1vhaZ0p8 = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.6,0.8))  
                                  
SR1laZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.8,1))    
SR1maZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.8,1))    
SR1haZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.8,1))    
SR1vhaZ1p0 = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.8,1))    
                                  
SR1laZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (1,1.2))  
SR1maZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (1,1.2))  
SR1haZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (1,1.2))  
SR1vhaZ1p2 = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (1,1.2))  
...
# SR1aX
SR1vlaX   = SR1 + Region("mt", (0,60)) + Region("l1_pt", (3.5,5)) + Region("CT1", (300,400))  + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1laX    = SR1 + Region("mt", (0,60)) + Region("l1_pt", (5,12))  + Region("CT1", (300,400))  + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1maX    = SR1 + Region("mt", (0,60)) + Region("l1_pt", (12,20)) + Region("CT1", (300,400))  + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1haX    = SR1 + Region("mt", (0,60)) + Region("l1_pt", (20,30)) + Region("CT1", (300,400))  + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))

# SR1aY
SR1vlaY   = SR1 + Region("mt", (0,60)) + Region("l1_pt", (3.5,5)) + Region("CT1", (400,-999)) + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1laY    = SR1 + Region("mt", (0,60)) + Region("l1_pt", (5,12))  + Region("CT1", (400,-999)) + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1maY    = SR1 + Region("mt", (0,60)) + Region("l1_pt", (12,20)) + Region("CT1", (400,-999)) + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1haY    = SR1 + Region("mt", (0,60)) + Region("l1_pt", (20,30)) + Region("CT1", (400,-999)) + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))

## CR1a
CR1aZ0p6  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0,0.6))
CR1aZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.6,0.8))  
CR1aZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.8,1))    
CR1aZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (1,1.2))  
CR1aZinf  = SR1 + SRZ + tightMuon + Region("mt", (0,60)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (1.2,-999)) 
CR1aX     = SR1 + Region("mt", (0,60)) + Region("l1_pt", (30,-999)) + Region("CT1", (300,400))  + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
CR1aY     = SR1 + Region("mt", (0,60)) + Region("l1_pt", (30,-999)) + Region("CT1", (400,-999)) + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
...
SR1lbZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.6,0.8))  
SR1mbZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.6,0.8))  
SR1hbZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.6,0.8))  
SR1vhbZ0p8 = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.6,0.8))  

SR1lbZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (0.8,1))
SR1mbZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (0.8,1))
SR1hbZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (0.8,1))
SR1vhbZ1p0 = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (0.8,1))

SR1lbZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (6,12))  + Region("(MET_pt/HT)", (1,1.2))  
SR1mbZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (12,20)) + Region("(MET_pt/HT)", (1,1.2))  
SR1hbZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (20,30)) + Region("(MET_pt/HT)", (1,1.2))  
SR1vhbZ1p2 = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (30,60)) + Region("(MET_pt/HT)", (1,1.2))  
...
# SR1bX
SR1vlbX   = SR1 + Region("mt", (60,95)) + Region("l1_pt", (3.5,5)) + Region("CT1", (300,400))  + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1lbX    = SR1 + Region("mt", (60,95)) + Region("l1_pt", (5,12))  + Region("CT1", (300,400))  + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1mbX    = SR1 + Region("mt", (60,95)) + Region("l1_pt", (12,20)) + Region("CT1", (300,400))  + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1hbX    = SR1 + Region("mt", (60,95)) + Region("l1_pt", (20,30)) + Region("CT1", (300,400))  + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))

# SR1bY
SR1vlbY   = SR1 + Region("mt", (60,95)) + Region("l1_pt", (3.5,5)) + Region("CT1", (400,-999)) + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1lbY    = SR1 + Region("mt", (60,95)) + Region("l1_pt", (5,12))  + Region("CT1", (400,-999)) + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1mbY    = SR1 + Region("mt", (60,95)) + Region("l1_pt", (12,20)) + Region("CT1", (400,-999)) + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
SR1hbY    = SR1 + Region("mt", (60,95)) + Region("l1_pt", (20,30)) + Region("CT1", (400,-999)) + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))

## CR1b
CR1bZ0p6  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0,0.6))
CR1bZ0p8  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.6,0.8))  
CR1bZ1p0  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (0.8,1))    
CR1bZ1p2  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (1,1.2))  
CR1bZinf  = SR1 + SRZ + tightMuon + Region("mt", (60,95)) + Region("l1_pt", (60,-999)) + Region("(MET_pt/HT)", (1.2,-999)) 
CR1bX     = SR1 + Region("mt", (60,95)) + Region("l1_pt", (30,-999)) + Region("CT1", (300,400))  + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
CR1bY     = SR1 + Region("mt", (60,95)) + Region("l1_pt", (30,-999)) + Region("CT1", (400,-999)) + Region("ISRJets_pt", (100,-999)) + Region("l1_eta", (-1.5, 1.5))
