...
## SR1a
# SR1aX
SR1vlaX = SR1 + Region("mt", (0,60)) + Region("l1_pt", (3.5,5)) + Region ("CT1", (300,400))    
SR1laX  = SR1 + Region("mt", (0,60)) + Region("l1_pt", (5,12))  + Region ("CT1", (300,400)) 
SR1maX  = SR1 + Region("mt", (0,60)) + Region("l1_pt", (12,20)) + Region ("CT1", (300,400)) 
SR1haX  = SR1 + Region("mt", (0,60)) + Region("l1_pt", (20,30)) + Region ("CT1", (300,400)) 

# SR1aY
SR1vlaY = SR1 + Region("mt", (0,60)) + Region("l1_pt", (3.5,5)) + Region ("CT1", (400,-999))    
SR1laY  = SR1 + Region("mt", (0,60)) + Region("l1_pt", (5,12))  + Region ("CT1", (400,-999))   
SR1maY  = SR1 + Region("mt", (0,60)) + Region("l1_pt", (12,20)) + Region ("CT1", (400,-999))  
SR1haY  = SR1 + Region("mt", (0,60)) + Region("l1_pt", (20,30)) + Region ("CT1", (400,-999))  

## CR1a
CR1aX   = CR1 + Region("mt", (0,60)) + Region ("CT1", (300,400))   
CR1aY   = CR1 + Region("mt", (0,60)) + Region ("CT1", (400, -999)) 

## SR1b
# SR1bX
SR1vlbX = SR1 + Region("mt", (60,95)) + Region("l1_pt", (3.5,5)) + Region ("CT1", (300,400))   
SR1lbX  = SR1 + Region("mt", (60,95)) + Region("l1_pt", (5,12))  + Region ("CT1", (300,400)) 
SR1mbX  = SR1 + Region("mt", (60,95)) + Region("l1_pt", (12,20)) + Region ("CT1", (300,400)) 
SR1hbX  = SR1 + Region("mt", (60,95)) + Region("l1_pt", (20,30)) + Region ("CT1", (300,400)) 

# SR1bY
SR1vlbY = SR1 + Region("mt", (60,95)) + Region("l1_pt", (3.5,5)) + Region ("CT1", (400,-999)) 
SR1lbY  = SR1 + Region("mt", (60,95)) + Region("l1_pt", (5,12))  + Region ("CT1", (400,-999)) 
SR1mbY  = SR1 + Region("mt", (60,95)) + Region("l1_pt", (12,20)) + Region ("CT1", (400,-999)) 
SR1hbY  = SR1 + Region("mt", (60,95)) + Region("l1_pt", (20,30)) + Region ("CT1", (400,-999)) 

## CR1b
CR1bX   = CR1 + Region("mt", (60,95)) + Region ("CT1", (300,400))   
CR1bY   = CR1 + Region("mt", (60,95)) + Region ("CT1", (400, -999)) 
