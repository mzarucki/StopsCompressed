...
class sms():
    ...
    def __init__(self, modelname):
        ...
        if modelname.find("T2bW_dm")   != -1: self.T2bW_dm()
        if modelname.find("TChiWZ_dm") != -1: self.TChiWZ_dm()
        if modelname.find("MSSM")      != -1: self.MSSM()
