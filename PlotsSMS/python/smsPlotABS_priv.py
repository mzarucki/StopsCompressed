...
class smsPlotABS(object):
    ...
    def DrawLegend(self):
        ...
        LExpP.SetPoint(0,self.model.Xmin+3*xRange/100, self.model.Ymax-1.20*yRange/100*10)   # FIXME
        LExpP.SetPoint(1,self.model.Xmin+10*xRange/100, self.model.Ymax-1.20*yRange/100*10)  # FIXME
        #LExpP.SetPoint(0,self.model.Xmin+3*xRange/100, self.model.Ymax-1.85*yRange/100*10)  # FIXME
        #LExpP.SetPoint(1,self.model.Xmin+10*xRange/100, self.model.Ymax-1.85*yRange/100*10) # FIXME
        ...
        LExp.SetLineStyle(7)
        LExp.SetLineWidth(4)
        LExp.SetPoint(0,self.model.Xmin+3*xRange/100, self.model.Ymax-1.35*yRange/100*10)   # FIXME
        LExp.SetPoint(1,self.model.Xmin+10*xRange/100, self.model.Ymax-1.35*yRange/100*10)  # FIXME
        #LExp.SetPoint(0,self.model.Xmin+3*xRange/100, self.model.Ymax-2.00*yRange/100*10)  # FIXME
        #LExp.SetPoint(1,self.model.Xmin+10*xRange/100, self.model.Ymax-2.00*yRange/100*10) # FIXME
        ...
        LExpM.SetPoint(0,self.model.Xmin+3*xRange/100, self.model.Ymax-1.50*yRange/100*10)   # FIXME
        LExpM.SetPoint(1,self.model.Xmin+10*xRange/100, self.model.Ymax-1.50*yRange/100*10)  # FIXME
        #LExpM.SetPoint(0,self.model.Xmin+3*xRange/100, self.model.Ymax-2.15*yRange/100*10)  # FIXME
        #LExpM.SetPoint(1,self.model.Xmin+10*xRange/100, self.model.Ymax-2.15*yRange/100*10) # FIXME

        textExp = rt.TLatex(self.model.Xmin+11*xRange/100, self.model.Ymax-1.50*yRange/100*10, "Expected (Baseline), median & 68%") # FIXME
        #textExp = rt.TLatex(self.model.Xmin+11*xRange/100, self.model.Ymax-2.15*yRange/100*10, "Expected, median & 68%") # FIXME
        ...
        LExp2.SetName("LExp")
        LExp2.SetTitle("LExp")
        LExp2.SetLineColor(color("kRed"))
        LExp2.SetLineStyle(7)
        LExp2.SetLineWidth(4)
        LExp2.SetPoint(0,self.model.Xmin+3*xRange/100, self.model.Ymax-2.00*yRange/100*10)  # FIXME
        LExp2.SetPoint(1,self.model.Xmin+10*xRange/100, self.model.Ymax-2.00*yRange/100*10) # FIXME
        
        textExp2 = rt.TLatex(self.model.Xmin+11*xRange/100, self.model.Ymax-2.15*yRange/100*10, "Expected (Baseline + lowMET)") # FIXME
        textExp2.SetTextFont(42)
        textExp2.SetTextSize(0.040)
        textExp2.Draw()
        self.c.textExp2 = textExp2

        #LObs.Draw("LSAME")  # FIXME
        #LObsM.Draw("LSAME") # FIXME
        #LObsP.Draw("LSAME") # FIXME
        LExp.Draw("LSAME")
        LExpM.Draw("LSAME")
        LExpP.Draw("LSAME")
        LExp2.Draw("LSAME")
        
        #self.c.LObs = LObs   # FIXME
        #self.c.LObsM = LObsM # FIXME
        #self.c.LObsP = LObsP # FIXME
        self.c.LExp = LExp
        self.c.LExpM = LExpM
        self.c.LExpP = LExpP
    ...
    def DrawLines(self):
        ...
        self.EXP['plus'].SetLineWidth(1) # FIXME               
        ##self.EXP['plus'].SetLineWidth(2) # FIXME               
        # expected
        self.EXP['nominal'].SetLineColor(color(self.EXP['colorLine']))
        self.EXP['nominal'].SetLineStyle(7) # FIXME
        self.EXP['nominal'].SetLineWidth(4)  # FIXME      
        #self.EXP['nominal'].SetLineWidth(4) # FIXME      
        # expected - 1sigma
        self.EXP['minus'].SetLineColor(color(self.EXP['colorLine']))
        self.EXP['minus'].SetLineStyle(7)
        self.EXP['minus'].SetLineWidth(1)  # FIXME                       
        #self.EXP['minus'].SetLineWidth(2) # FIXME                        
        # DRAW LINES
        self.EXP['nominal'].Draw("LSAME")
        self.EXP['plus'].Draw("LSAME")
        self.EXP['minus'].Draw("LSAME")
        #self.OBS['nominal'].Draw("LSAME") # FIXME
        #self.OBS['plus'].Draw("LSAME")    # FIXME
        #self.OBS['minus'].Draw("LSAME")   # FIXME         
